...
static int jz_dmic_contoller_init(struct snd_soc_dai *dai)
{
		...
		struct snd_soc_dai *dai)
{
	...
	/* dmic recording conflict with voice trigger wakeup, so initialize dmic controller again. */
	jz_dmic_contoller_init(dai);
