...
#define DMIC_CHNUM		5
#define DMIC_CHNUM_MASK			(0x1 << DMIC_CHNUM)
...
#define __dmic_disable_split(dev)\
		dmic_set_reg(dev,DMICCR0,0,DMIC_SPLIT_DI_MASK,DMIC_SPLIT_DI)
...
#define DMIC_FIFO_THR_MASK	(0x7f << DMIC_FIFO_THR)
...
#define DMIC_FIFO_LVL_MASK	(0x7f << DMIC_FIFO_LVL)
