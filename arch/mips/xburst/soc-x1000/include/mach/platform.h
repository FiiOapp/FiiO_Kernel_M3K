...
#define MSC0_PORTA_4BIT_INPUT                                                 \
        { .name = "msc0-pa-4bit", .port = GPIO_PORT_A, .func = GPIO_INPUT, .pins = 0x3f0 << 16, }
...
#define PO_EN_PORTA { .name = "po_en", .port = GPIO_PORT_A, .func = GPIO_OUTPUT0, .pins = 1 << 16, }
	
/****************************************************************************************/
#define SFC_PORTA							\
	{ .name = "sfc", .port = GPIO_PORT_A, .func = GPIO_FUNC_1 | GPIO_PULL, .pins = 0x3f << 26, }
/****************************************************************************************/
...
#define SLCDC_PORTAB_8BIT_INPUT                                               \
        { .name = "slcd", .port = GPIO_PORT_A, .func = GPIO_INPUT, .pins = 0xff, }

#define SLCDC_PORTAB_8BIT_OUTPUT                                               \
        { .name = "slcd", .port = GPIO_PORT_A, .func = GPIO_FUNC_1, .pins = 0xff, }
...
#define SLCDC_PORTAB_16BIT_INPUT                                              \
        { .name = "slcd", .port = GPIO_PORT_A, .func = GPIO_INPUT, .pins = 0xffff, },\
        { .name = "slcd", .port = GPIO_PORT_B, .func = GPIO_INPUT, .pins = 0x12 << 16, }

#define SLCDC_PORTAB_16BIT_INPUT_1                                              \
        { .name = "slcd", .port = GPIO_PORT_A, .func = GPIO_INPUT, .pins = 0xffff, }


#define PWM_PORTC_BIT0							\
	{ .name = "pwm0", .port = GPIO_PORT_C, .func = GPIO_FUNC_0, .pins = 1 << 25, }
#define PWM_PORTC_BIT0_OUTPUT0                                                  \
        { .name = "pwm0", .port = GPIO_PORT_C, .func = GPIO_OUTPUT0, .pins = 1 << 25, }
...
#define PWM_PORTC_BIT4							\
	{ .name = "pwm4", .port = GPIO_PORT_C, .func = GPIO_OUTPUT1, .pins = 1 << 24, }
#define PWM_PORTC_BIT4_INPUT                                                  \
        { .name = "pwm4", .port = GPIO_PORT_C, .func = GPIO_INPUT, .pins = 1 << 24, }
...
extern struct platform_device emxx_battery_device;
