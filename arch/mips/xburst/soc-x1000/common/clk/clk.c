...
void __init init_all_clk(void)
{
	...
	printk("PLL:%luMHZ APLL:%luMHZ MPLL:%luMHZ CCLK:%luMHz L2CLK:%luMhz H0CLK:%luMHz H2CLK:%luMhz PCLK:%luMhz\n",
		    clk_srcs[CLK_ID_PLL].rate/1000/1000,
		    clk_srcs[CLK_ID_APLL].rate/1000/1000,
		    clk_srcs[CLK_ID_MPLL].rate/1000/1000,
