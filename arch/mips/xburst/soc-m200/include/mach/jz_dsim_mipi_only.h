...
extern int mipi_dsi_register_lcd_driver(struct mipi_dsim_lcd_driver *lcd_drv);
extern int mipi_dsi_register_lcd_device(struct mipi_dsim_lcd_device*lcd_drv);
/**
