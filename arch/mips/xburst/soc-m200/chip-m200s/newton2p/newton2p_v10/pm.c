...
__initdata int gpio_ss_table[][2] = {
	...
	/* GPIO Group - D */
	{32*3+0,	GSS_IGNORE 		},      /*GPIO_LCD_BLK_EN*/
	{32*3+3,	GSS_IGNORE 		},	/*GPIO_MIPI_RST_N*/
	{32*3+4,	GSS_IGNORE 		},	/*DSI_TE_GPIO*/
	{32*3+12,	GSS_IGNORE 		},	/*WL_WAKEUP_HOST*/
	{32*3+13,	GSS_IGNORE 		},	/*WL_REG_EN*/
