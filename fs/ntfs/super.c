...
/* for report to app to mount ntfs-3g */
...
get_ctx_vol_failed:
	...
	printk(KERN_INFO "NTFS volume version %i.%i.\n", vol->major_ver,
			vol->minor_ver);
	/* report app to mount ntfs-3g*/
	printk("mount ntfs event :key code 71\n");
                                input_event(headset,EV_KEY, KEY_KP7,1);
                                input_event(headset,EV_KEY,KEY_KP7, 0);
                                input_sync(headset);
