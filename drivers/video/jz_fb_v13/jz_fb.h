...
extern struct fb_info *off_info;
extern struct jzfb *jzfb_1;
extern void slcd_send_mcu_command(struct jzfb *jzfb, unsigned long cmd);
extern void jzfb_slcd_display_off(struct fb_info *info);
extern int jzfb_set_par(struct fb_info *info);
extern int slcd_off_sign;
