...
wl_cfgp2p_ifadd(struct wl_priv *wl, struct ether_addr *mac, u8 if_type,
		chanspec_t chspec);
extern s32 wl_cfgp2p_ifdisable(struct wl_priv *wl, struct ether_addr *mac);
...
wl_cfgp2p_escan(struct wl_priv *wl, struct net_device *dev, u16 active,
		...
		u32 bssidx, struct ether_addr *tx_dst_addr,
...
extern wifi_wfd_ie_t *wl_cfgp2p_find_wfdie(u8 * parse, u32 len);
extern s32
...
extern struct net_device *wl_cfgp2p_find_ndev(struct wl_priv *wl, s32 bssidx);
extern s32 wl_cfgp2p_find_type(struct wl_priv *wl, s32 bssidx, s32 * type);
...
extern u8 *wl_cfgp2p_find_attrib_in_all_p2p_Ies(u8 * parse, u32 len,
						u32 attrib);
...
#if defined(WL_CFG80211_P2P_DEV_IF)
extern struct wireless_dev *wl_cfgp2p_add_p2p_disc_if(void);
