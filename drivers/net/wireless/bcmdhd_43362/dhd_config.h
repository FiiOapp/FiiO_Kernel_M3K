...
void dhd_conf_set_fw_name_by_mac(dhd_pub_t * dhd, bcmsdh_info_t * sdh,
				 char *fw_path);
void dhd_conf_set_nv_name_by_mac(dhd_pub_t * dhd, bcmsdh_info_t * sdh,
				 char *nv_path);
...
#endif
void dhd_conf_set_conf_path_by_nv_path(dhd_pub_t * dhd, char *conf_path,
				       char *nv_path);
